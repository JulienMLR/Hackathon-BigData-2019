##############################
# Shiny App: ImaginR - Exploration uni- bi- et multi-variée avec R
# User interface
##############################

shinyUI(fluidPage(
  theme = shinytheme("united"),
  titlePanel("ImaginR - Exploration uni- bi- et multivariée avec R",
             tags$head(tags$link(rel = "icon", type = "image/png", href = "favicon.png"),
                       tags$title("ImaginR - Exploration uni- bi- et multivariée avec R"),
